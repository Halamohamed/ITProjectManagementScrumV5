...
public class SprintController {
    ...
    public String addTeamToSprint(@ModelAttribute("teamAttr") Team  team,String id) {
        Sprint sprintname=repository.findById(id).get();
        Set<Team> teammember=sprintname.getTeams();
        teammember.add(team);
        sprintname.setTeam((Team) teammember);

        repository.save(sprintname);
